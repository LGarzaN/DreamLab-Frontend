                ...
                <div className='w-full flex  justify-around'>
                    ...
                    <div className='Fecha flex items-center justify-start w-[15vw] '>
                        <div className= "hidden sm:block">
                            <Select.Root defaultValue="Fecha" onValueChange={handleDateChange} size="3">
                                <Select.Trigger />
                                <Select.Content>
                                    <Select.Group>
                    ...
                    <div className='Hora flex items-center justify-center w-[18vw] '>
                        <div className= 'hidden sm:block mr-2'>
                            <Select.Root defaultValue="Hora" onValueChange={handleHourChange} size="3">
                                <Select.Trigger />
                                <Select.Content>
                                    <Select.Group>
                    ...
                    <div className='Area flex items-center justify-start w-[17vw] '>
                        <div className= "hidden sm:block">
                            <Select.Root defaultValue="Espacios" onValueChange={handleAreaChange} size="3">
                                <Select.Trigger />
                                <Select.Content>
                                    <Select.Group>
                                        <Select.Item value="Espacios">Espacios</Select.Item>
                                        <Select.Item value="Social Networking">Social Networking</Select.Item>
                                        <Select.Item value="Lego Room">Lego Room</Select.Item>
                                        <Select.Item value="Electric Garage">Electric Garage</Select.Item>
                                        <Select.Item value="Dimension Forge">Dimension Forge</Select.Item>
                                        <Select.Item value="New Horizons">New Horizons</Select.Item>
                                        ...
                                        <Select.Item value="Hack-Battlefield">Hack-Battlefield</Select.Item>
                                        <Select.Item value="Testing-Land">Testing-Land</Select.Item>
                                        <Select.Item value="War Headquarter">War Headquarter</Select.Item>
                                        <Select.Item value="Biometrics Flexible">Biometrics Flexible</Select.Item>
                                        <Select.Item value="Beyon Digits">Beyon Digits</Select.Item>
                                        <Select.Item value="Open Innovation Lab">Open Innovation Lab</Select.Item>
            ...
            <div className='w-full flex flex-col justify-center items-center mt-8 space-y-5'>
                ...
                <div className='w-[85vw] h-28 bg-[#293038] rounded-xl flex flex-row items-center'>
                    <div className='md:w-[30vw] flex flex-col pl-9 space-y-2 justify-center'>
                        <h1 key={index} className='text-2xl font-semibold'>{prueba.nombre}</h1>
                        <h2 key={index} className='text-xl'>{prueba.matricula}</h2>
                    </div>
            ...
            <div className='w-full flex flex-col justify-center items-center mt-8 space-y-5'>
                ...
                <div className='w-[85vw] h-28 bg-[#293038] rounded-xl flex flex-row items-center justify-around'>
                    <div className='w-[50vw] pl-2'> 
                        <h1 key={index} className='font-semibold truncate'> {prueba.nombre} </h1>
                        <h1 key={index} className='text-xs'> {prueba.matricula} </h1>
                        <div className='flex flex-row'>
                            <h1 key={index} className='font-semibold'> {prueba.dia}  </h1>
                            <h1 key={index} className='font-semibold'> {prueba.fecha} </h1>
                        </div>
                        <div className='flex flex-row'>
                            <h1 key={index} className='text-xs'> {prueba.hora_inicio}  </h1>
                            <h1 className='text-xs'> - </h1>
                            <h1 key={index} className='text-xs'> {prueba.hora_fin} </h1>
                        </div>
                    </div>
                    <div className='w-[28vw]'> 
                        <img src="/areas/social_network.jpeg" className='rounded-xl h-20'/>
                    </div>
                </div>
                ))}
            </div>
